...
find "$RPM_BUILD_ROOT" -type d -name 'CVS' -print0 | xargs -0 rm -r
...
%attr(755,root,root) %{_prefix}/System/Applications/GWorkspace.app/%{gscpu}/%{gsos}/%{libcombo}/GWorkspace
...
%attr(755,root,root) %{gsservicedir}/thumbnailer.service/%{gscpu}/%{gsos}/%{libcombo}/*
...
%{_prefix}/System/Library/Bundles/*.viewer/Resources/*.lproj
...
%attr(755,root,root) %{_prefix}/System/Library/Libraries/%{gstriple}/*
...
%dir %{_prefix}/System/Applications/GWorkspace.app/Resources
%{_prefix}/System/Applications/GWorkspace.app/Resources/*.plist
%{_prefix}/System/Applications/GWorkspace.app/Resources/*.lproj
%{_prefix}/System/Applications/GWorkspace.app/Resources/*.desktop
%{_prefix}/System/Applications/GWorkspace.app/Resources/*.tiff
...
%{_prefix}/System/Applications/GWorkspace.app/Resources/*.viewer/Resources/*.lproj
